    ...
    if(o_url.pathname == '/'){
        return new Response(
            await Deno.readTextFile(
                `${s_path_abs_folder_current}/localhost/auto.html`
            ),
            { 
                headers: {
...
//     s_path_certificate_file: './self_signed_cert_a1b48237-384d-4d2b-863a-1d0cb10967ce.crt',
//     s_path_key_file: './self_signed_key_a1b48237-384d-4d2b-863a-1d0cb10967ce.key'
// }
